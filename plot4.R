...
with(epc_sub, plot(datetime, Voltage, type="l"))

with(epc_sub, plot(datetime, Sub_metering_1, type="l", ylab="Energy sub metering", xlab=""))
with(epc_sub, lines(datetime, Sub_metering_2, col="red"))
with(epc_sub, lines(datetime, Sub_metering_3, col="blue"))
legend("topright", legend = c('Sub_metering_1',"Sub_metering_2","Sub_metering_3"), col=c("black","red","blue"), lty=1)
with(epc_sub, plot(datetime, Global_reactive_power, type="l"))
dev.off()